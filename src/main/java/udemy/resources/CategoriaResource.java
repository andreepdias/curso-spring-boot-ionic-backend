...
import udemy.dto.CategoriaDTO;
import udemy.services.CategoriaService;
...
public class CategoriaResource {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 400, message = "Não é possível excluir uma categoria que possui produtos associados."),
