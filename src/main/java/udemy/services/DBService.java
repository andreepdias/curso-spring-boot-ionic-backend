...
import udemy.domain.Pagamento;
import udemy.domain.PagamentoComBoleto;
import udemy.domain.PagamentoComCartao;
...
import udemy.repositories.CategoriaRepository;
...
import udemy.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Andre Dev", "andreeduardo.dev@gmail.com", "07365745908", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("123456", "654897"));

		Cliente cli2 = new Cliente(null, "Andre Dias", "andreeduardo1997@gmail.com", "07365745908", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("223456", "354897"));
		...
		Endereco e3 = new Endereco(null, "Avenida Rita", "690", "Sala 4", "Centro", "89223123", cli2, c2);
