...
import udemySpringBoot.domain.Cidade;
import udemySpringBoot.domain.Cliente;
import udemySpringBoot.domain.Endereco;
import udemySpringBoot.domain.Estado;
import udemySpringBoot.domain.ItemPedido;
import udemySpringBoot.domain.Pagamento;
import udemySpringBoot.domain.PagamentoComBoleto;
import udemySpringBoot.domain.PagamentoComCartao;
import udemySpringBoot.domain.Pedido;
import udemySpringBoot.domain.Produto;
import udemySpringBoot.domain.enums.EstadoPagamento;
import udemySpringBoot.domain.enums.TipoCliente;
import udemySpringBoot.repositories.CategoriaRepository;
import udemySpringBoot.repositories.CidadeRepository;
import udemySpringBoot.repositories.ClienteRepository;
import udemySpringBoot.repositories.EnderecoRepository;
import udemySpringBoot.repositories.EstadoRepository;
import udemySpringBoot.repositories.ItemPedidoRepository;
import udemySpringBoot.repositories.PagamentoRepository;
import udemySpringBoot.repositories.PedidoRepository;
import udemySpringBoot.repositories.ProdutoRepository;
